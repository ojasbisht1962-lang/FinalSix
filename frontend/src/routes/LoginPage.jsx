...
// Updated: 2025-11-21 - Force deploy
            ...
            <div className="space-y-4">
              ...
              <div className="w-full mb-4">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 bg-red-500 border-4 border-yellow-400 text-white px-6 py-4 rounded-xl font-bold hover:bg-red-600 hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed group shadow-lg"
